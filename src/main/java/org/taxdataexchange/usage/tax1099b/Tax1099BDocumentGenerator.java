...
import irs.fdxtax640.jsonserializers.Tax1099BSerializer;
import irs.fdxtax640.jsonserializers.TaxStatementListSerializer;
import irs.fdxtax640.map2objects.Map2Tax1099B;
import irs.fdxtax640.obj2mappers.TaxStatementList2Map;

import org.apache.commons.lang3.time.StopWatch;
import org.taxdataexchange.core.pdfbuilders.Tax1099BPdfBuilder;
...
public class Tax1099BDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099B obj = Map2Tax1099B.generate( row );
        {
            String asJson = Tax1099BSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099B.csv";
        ...
        String outputFileName = "Tax1099B.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099BDocumentGenerator generator = new Tax1099BDocumentGenerator( );
