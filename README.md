# tax-doc-sdk-tax1099b

Software development kit to generate IRS Form 1099-B as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099B.sample.png" width="850"/>
